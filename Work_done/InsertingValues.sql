...
Use EuroSoccer
Insert into League(id, country_id , league_name)
...
select [id]
      ...
      ,[team_long_name]
      ,[team_short_name]
from openquery(MYSQLITE, 'select * from team where ')
select * from team
Use EuroSoccer
...
into test
from openquery(MYSQLITE, 'select * from team_attributes where team_ fifa_api_id is not null ')